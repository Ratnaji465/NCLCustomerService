...
class ViewCustomerProjectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        contactContractorList = (intent.getSerializableExtra("CustomerProjectList") as CustomerProjectResVO?)!!
        if(contactContractorList!=null){
            ...
            if(contactContractorList.projectHead!=null && contactContractorList.projectHead.size>0){
                ...
                if (contactContractorList.projectHead.get(0).associateContacts!=null && contactContractorList.projectHead.get(0).associateContacts.size>0){
